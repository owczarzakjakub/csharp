            ...
            while(true)
            {
                ...
                switch(choice)
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        float sideA = GetValidInput("Podaj dlugosc boku A: ");
                        float sideB = GetValidInput("Podaj dlugosc boku B: ");
                        float sideC = GetValidInput("Podaj dlugosc boku C: ");

                        if (isValidTriangle(sideA, sideB, sideC))
                        {
                            Triangle triangle = new Triangle(sideA, sideB, sideC);
                            Console.WriteLine("Powierzchnia trojkata wynosi: " + triangle.CalculateArea());
                            Console.WriteLine("Obwod trojkata wynosi: " + triangle.CalculatePerimeter();
                        }
                        else
                        {
                            Console.ForegroundColor = ConsoleColor.Red;
                            Console.WriteLine("POdane dlugosci bokow nie tworza trojkata");
                            Console.ResetColor
                        }
